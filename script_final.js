...
function switchTAB() {
	...
	if(i%2 == 0) {
		...
		document.getElementById("search-switch").style= "display: block; margin-left: 65%;";
	}else {
...
function goFurther(){
  if (document.getElementById("chkAgree").checked == true) {
    document.getElementById('btnSubmit').style = 'background: linear-gradient(to right, #FA4B37, #27ABDF);';
  }
  else{
...
function display(n) {
  ...
  s1.style = 'background: #27ABDF; color: #FFF;';
  s2.style = 'background: #27ABDF; color: #FFF;';
  s3.style = 'background: #27ABDF; color: #FFF;';
  s4.style = 'background: #27ABDF; color: #FFF;';

  if(n==1) {
    img1.style = 'display: block;';
    s1.style = 'background: #E8E5EF; color: #27ABDF;';
  }
  if(n==2) {
    img2.style = 'display: block;';
    s2.style = 'background: #E8E5EF; color: #27ABDF;';
  }
  if(n==3) {
    img3.style = 'display: block;';
    s3.style = 'background: #E8E5EF; color: #27ABDF;';
  }
  if(n==4) {
    img4.style = 'display: block;';
    s4.style = 'background: #E8E5EF; color: #27ABDF;';
  } 
}
